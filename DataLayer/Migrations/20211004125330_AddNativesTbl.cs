...
{
    public partial class AddNativesTbl : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NativeName = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Natives", x => x.NativeId);
                });
